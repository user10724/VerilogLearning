...
## PMOD Header JC
#set_property -dict {PACKAGE_PIN AC26 IOSTANDARD LVCMOS33} [get_ports clk_out1]
#set_property -dict {PACKAGE_PIN AJ27 IOSTANDARD LVCMOS33} [get_ports clk_out2]
#set_property -dict {PACKAGE_PIN AH30 IOSTANDARD LVCMOS33} [get_ports clk_out3]
#set_property -dict {PACKAGE_PIN AK29 IOSTANDARD LVCMOS33} [get_ports clk_out4]
