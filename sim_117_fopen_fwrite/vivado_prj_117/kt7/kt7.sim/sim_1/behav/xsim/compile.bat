...
REM
REM Generated by Vivado on Sat Nov 26 16:18:02 +0800 2022
...
echo "xvlog --incr --relax -prj vlg_design_vlog.prj"
call xvlog  --incr --relax -prj vlg_design_vlog.prj -log xvlog.log
